...
const Cardio: React.FC = () => {
  ...
  const initialExercises = [
    { id: '1', name: 'Running', image: require('./images/bicep_curls.jpg'), details: ['Warm up for 5 minutes with light jogging.', 'Run at a moderate pace for 20 minutes.', 'Cool down with a 5-minute walk.', 'Stretch your muscles after the workout.'], },
    { id: '2', name: 'Cycling', image: require('./images/bicep_curls.jpg'), details: ['Adjust your seat and handlebars to a comfortable position.', 'Pedal at a moderate pace for 30 minutes.', 'Increase intensity or resistance for added challenge.', 'Cool down with a few minutes of easy cycling.', 'Stretch your legs and lower back.'], },
    { id: '3', name: 'Jump Rope', image: require('./images/bicep_curls.jpg'), details: ['Hold the jump rope handles at hip level.', 'Jump with both feet together over the rope.', 'Maintain a steady rhythm for 10 minutes.', 'Take short breaks if needed.', 'Increase speed or try variations for more intensity.'], },
