...
const Chest: React.FC = () => {
  ...
  const initialExercises = [
    { id: '1', name: 'Bench Press', image: require('./images/bicep_curls.jpg'), details: ['Lie on a flat bench with your feet flat on the floor.', 'Grip the barbell slightly wider than shoulder-width apart.', 'Lower the barbell to your chest, keeping your elbows close to your body.', 'Press the barbell back up to the starting position.', 'Repeat for the desired number of repetitions.'], },
    { id: '2', name: 'Push-ups', image: require('./images/bicep_curls.jpg'), details: ['Start in a plank position with your hands slightly wider than shoulder-width apart.', 'Lower your body until your chest nearly touches the floor.', 'Push yourself back up to the starting position.', 'Keep your core engaged and maintain a straight line from head to heels throughout the exercise.', 'Repeat for the desired number of repetitions.'], },
    { id: '3', name: 'Dumbbell Flyes', image: require('./images/bicep_curls.jpg'), details: ['Lie on a flat bench with a dumbbell in each hand.', 'Extend your arms directly above your chest, palms facing each other.', 'Lower the dumbbells out to the sides in a wide arc.', 'Bring the dumbbells back up over your chest, squeezing your pecs.', 'Repeat for the desired number of repetitions.'], },
